/**
 * Account login / key derivation helper, ported from bitsharesjs
 * `lib/chain/src/AccountLogin.js`.
 *
 * Modernized: ES module imports, uses local `key` from `../ecc/key.js`
 * (which re-exports the KeyUtils functionality) and local `PrivateKey`.
 */

import PrivateKey from "../ecc/PrivateKey.js";
import { key } from "../ecc/key.js";
