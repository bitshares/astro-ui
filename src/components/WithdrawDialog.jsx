...
export default function WithdrawPermissions(properties) {
  ...
  const form = useForm({
    defaultValues: {
      ...
      amountAvailable: "",
      withdrawAmount: 0,
      withdrawalPeriodSec: 3600,
      periodsUntilExpiration: 1,
      periodStartTime: "",
    },
  });
  ...
  const [withdrawalPeriodSec, setWithdrawalPeriodSec] = useState(
    _withdrawalPeriodSec || 1
  );
  ...
  const [openCreateWithdrawPermission, setOpenCreateWithdrawPermission] =
    useState(false); // deeplinkdialog create permission
  const [openEditWithdrawPermission, setOpenEditWithdrawPermission] =
    useState(false); // deeplinkdialog edit permission
  ...
  return (
    ...
    >
      <DialogTrigger asChild>
        <Button variant="default" size="icon" className="mr-2 w-full">
          {mode === "edit"
          ...
          >
            <FieldGroup>
                    ...
                    <HoverInfo
                      content={
                        !targetUser || !targetUser.name
                          ...
                          : t(
                              "WithdrawPermissions:targetAccountDescriptionWithName",
                              {
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <HoverInfo
                      content={t(
                        "WithdrawPermissions:limitedAssetsToWithdraw_description"
                      )}
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        <HoverInfo
                          ...
                          content={t(
                            "WithdrawDialog:amountAvailableDescription"
                          )}
                        />
                        <Input
                          {...field}
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        <HoverInfo
                          content={t(
                            "WithdrawDialog:withdrawAmountLimitDescription"
                          )}
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <HoverInfo
                        content={t(
                          "WithdrawPermissions:withdrawal_period_sec_description"
                        )}
                      ...
                      <Select
                        onValueChange={(value) => {
                          ...
                          field.onChange(hoursToSeconds[value]);
                        }}
                        value={
                          Object.keys(hoursToSeconds).find(
                            (key) => hoursToSeconds[key] === withdrawalPeriodSec
                          ) ||
                          Object.keys(hoursToSeconds).reduce((prev, curr) => {
                            return Math.abs(
                              hoursToSeconds[curr] - withdrawalPeriodSec
                            ) <
                              Math.abs(
                                hoursToSeconds[prev] - withdrawalPeriodSec
                              )
                              ? curr
                              : prev;
                      ...
                      >
                        <SelectTrigger className="mb-3 mt-1 w-full">
                          <SelectValue
                            placeholder={
                              Object.keys(hoursToSeconds).find((key) => {
                                return (
                                  hoursToSeconds[key] === withdrawalPeriodSec
                                );
                              }) || "1hr"
                            }
                          />
                        ...
                        <SelectContent className="bg-card">
                          ...
                          <SelectItem value="6hrs">
                            {t("WithdrawDialog:6hrs")}
                          </SelectItem>
                          <SelectItem value="12hrs">
                            {t("WithdrawDialog:12hrs")}
                          </SelectItem>
                          <SelectItem value="24hrs">
                            {t("WithdrawDialog:24hrs")}
                          </SelectItem>
                          <SelectItem value="7d">
                            {t("WithdrawDialog:7d")}
                          </SelectItem>
                          <SelectItem value="14d">
                            {t("WithdrawDialog:14d")}
                          </SelectItem>
                          <SelectItem value="30d">
                            {t("WithdrawDialog:30d")}
                          </SelectItem>
                          <SelectItem value="6m">
                            {t("WithdrawDialog:6m")}
                          </SelectItem>
                          <SelectItem value="12m">
                            {t("WithdrawDialog:12m")}
                          </SelectItem>
                        </SelectContent>
                      </Select>
                      {fieldState.invalid && (
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <HoverInfo
                        content={t(
                          "WithdrawPermissions:periods_until_expiration_description"
                        )}
                        header={t(
                          "WithdrawPermissions:periods_until_expiration"
                        )}
                      />
                      <Input
                        {...field}
                        ...
                        onChange={(e) => {
                          ...
                          setPeriodsUntilExpiration(value);
              ...
              <div className="grid grid-cols-1 gap-3">
                <HoverInfo
                  content={t(
                    "WithdrawPermissions:period_start_time_description"
                  )}
              ...
              {openEditWithdrawPermission ? (
                <DeepLinkDialog
                  ...
                  headerText={t(
                    "WithdrawPermissions:editWithdrawPermissionHeader"
                  )}
                  trxJSON={[
                    {
                      withdraw_from_account: usr.id,
