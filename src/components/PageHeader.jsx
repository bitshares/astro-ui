...
const ACCENTS = {
  ...
  swap: { color: "dark:text-blue-300 text-blue-600", bg: "dark:bg-blue-500/15 bg-blue-100/80", border: "group-hover/navitem:dark:border-blue-400/30 group-hover/navitem:border-blue-400/50" },
  ...
  withdraw_permissions: { color: "dark:text-blue-300 text-blue-600", bg: "dark:bg-blue-500/15 bg-blue-100/80", border: "group-hover/navitem:dark:border-blue-400/30 group-hover/navitem:border-blue-400/50" },
  ...
  deals: { color: "dark:text-blue-300 text-blue-600", bg: "dark:bg-blue-500/15 bg-blue-100/80", border: "group-hover/navitem:dark:border-blue-400/30 group-hover/navitem:border-blue-400/50" },
  ...
  blocks: { color: "dark:text-slate-300 text-slate-600", bg: "dark:bg-slate-500/15 bg-slate-100/80", border: "group-hover/navitem:dark:border-slate-400/30 group-hover/navitem:border-slate-400/50" },
  ...
  accountLists: { color: "dark:text-slate-300 text-slate-600", bg: "dark:bg-slate-500/15 bg-slate-100/80", border: "group-hover/navitem:dark:border-slate-400/30 group-hover/navitem:border-slate-400/50" },
...
const SECTION_ACCENT = {
  ...
  blockchain: { bar: "from-slate-500 via-gray-400 to-zinc-500", chip: "dark:bg-slate-500/20 dark:text-slate-200 dark:border-slate-400/30 bg-slate-100 text-slate-700 border-slate-300", dot: "bg-slate-400" },
